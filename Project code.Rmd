...
```{r setup}
required_columns <- c(
  "ID", "riskHI", "riskLOW", "tleyapca", "tleltpca", 
  "extspa", "extsta", 
  "echrdpa", "SESA", 
...
datasubset <- data %>%
  select(ID, extspa, extsta, EXTSXA, echrdpa, SESA, tleyapca, tleltpca, riskHI, riskLOW, tinstca, trelaca, thosica)
print(datasubset)
